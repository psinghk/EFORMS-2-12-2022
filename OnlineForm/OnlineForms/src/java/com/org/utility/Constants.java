...
public class Constants {
    ...
    public static final String BULK_USER = "bulk_users";
    public static final String BULK_TABLE_NAME = "bulk_registration";
    public static final String BULKDIST_TABLE_NAME = "bulk_distribution_registration"; //line Added by Rahul jan 2021
    ...
    public static final String PROFILE_TABLE_NAME = "mobile_registration";
    public static final String MAIL_ADMIN_PENDING = "Pending with Admin";
    public static final String DNS_FORM_KEYWORD = "dns";
    public static final String DOR_EXT_RETIRED_FORM_KEYWORD = "dor_ext_retired";
    ...
    public static final String DAONBOARDING_TABLE_NAME = "daonboarding_registration";
    public static final String DAONBOARDING_FORM_KEYWORD = "daonboarding";
   ...
   // public static final String DNS_GOV_FIRST_COORD = "preeti.nhq@nic.in,raheja_preeti@yahoo.co.in";
    ...
    public static final String BULKDIST_FORM_KEYWORD = "bulkdlist";    // Added by Rahul jan 2021
   ...
   // public static final String GEM_DA_ADMIN = "lily.prasad@gem.gov.in"; // above line modified by pr on 31stjul19
     public static final String GEM_DA_ADMIN = "vp-product@gem.gov.in"; // above line modified by shweta on 24feb21
    ...
    public static final String PROFILE_FORM_KEYWORD = "profile";

    public static final String WIFI_PORT_TABLE_NAME = "wifiport_registration";
    public static final String WIFI_PORT_FORM_KEYWORD = "wifiport";
    public static final String OTP_UPDATE_MOBILE_TABLE = "otp_save_update_mobile";
    
    public static final String DOR_EXT_TABLE_NAME = "dor_ext_registration";
    public static final String DOR_EXT_FORM_KEYWORD = "dor_ext";
    public static final String DOR_EXT_RT_FORM_KEYWORD = "dor_ext_retired";
    public static String DOR_EXT_RETIRED_TABLE_NAME = "dor_ext_retired_registration";
