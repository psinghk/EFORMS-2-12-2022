                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                } else if (showEdit)
                                {
                                    ...
                                    {
                                        $("#sms_preview .edit,.save-changes").show();
                                    }
                    ...
                    $.ajax({
                        ...
                        if (dataResponse.trim() != '' && dataResponse != null) {
                            ...
                            if (!showEdit) // to show /hide edit on preview based on stat_type
                            {
                                ...
                                {
                                    $("#dns_preview .edit,.save-changes").show();
                                }
                                // end, code added by pr on 25thjan18
                            }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#wifi_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#singleuser_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#ldap_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                } else if (showEdit)
                                {
                                    ...
                                    {
                                        $("#imappop_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#mobile_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#nkn_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#gem_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#bulkuser_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                                if (jsonvalue.prvw_type === 'mail') {
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#distribution_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
...
//                                alert(jsonvalue.moderator.length == 0);
                ...
                // For DlistBulk Request  jan 2021 Added by Rahul
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (jsonvalue.Excelfile !== undefined && jsonvalue.Excelfile !== null && jsonvalue.Excelfile) {
                                    ...
                                    $.each(jsonvalue.Excelfile, function (k, v) {
                                        ...
                                        <td>` + v.list_name + `</td>
                                        <td>` + v.description_list + `</td>
                                        <td>` + v.list_mod + `</td>
                                        <td>` + v.allowed_member + `</td>
                                        <td>` + v.list_temp + `</td>
                                        <td>` + v.mail_Acceptance + `</td>
                                        <td>` + v.owner_Name + `</td>
                                        <td>` + v.Owner_Email + `</td>
                                        <td>` + v.owner_Mobile + `</td>
                                        <td>` + v.moderator_Name + `</td>
                                        <td>` + v.moderator_Email + `</td>
                                        <td>` + v.moderator_Mobile + `</td>
                                        <td>` + v.owner_Admin + `</td>
                                        <td>` + v.moderator_Admin + `</td>
                                    </tr>`;
                                    });
                                    console.log(tbody)
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#relay_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#ip_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                } else if (showEdit)
                                {
                                    ...
                                    {
                                        $("#webcast_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                } else if (showEdit)
                                {
                                    ...
                                    {
                                        $("#centralutm_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
...
//                                }
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    console.log("inside wifiport showedit false ");
                                    $("#wifiport_preview .edit,.save-changes").hide();
//                                    $("#wifiport_preview .edit").addClass('display-hide');
//                                    $('#wifiport_preview .save-changes').addClass('display-hide'); // line added by pr on 20thdec17                                                            
                                ...
                                } else if (showEdit)
                                {
                                    if (comingFrom === 'admin')
                                    {
                                        $("#wifiport_preview .edit").show();
                                        //  $("#wifiport_preview .edit").addClass('display-hide');
                                        $('#wifiport_preview .save-changes').addClass('display-hide');
                                    } else
                                    {
                                        $("#wifiport_preview .save-changes").hide();
                                        $("#wifiport_preview .edit").show();
                                    }
                                }
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    ...
                                    {
                                        $("#vpn_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
                    ...
                    dataType: 'html', complete: function () {
                        ...
                        .done(function (dataResponse) {
                            ...
                            if (dataResponse.trim() != '' && dataResponse != null) {
                                ...
                                if (!showEdit) // to show /hide edit on preview based on stat_type
                                {
                                    $("#daonboarding_preview .edit,.save-changes").hide();
                                } else if (showEdit) {
                                    // start, code added by pr on 25thjan18                            
                                    if (comingFrom === 'admin')
                                    {
                                        $("#daonboarding_preview .edit").addClass('display-hide');
                                        $('#daonboarding_preview .save-changes').addClass('display-hide'); // line added by pr on 20thdec17                                                            
                                    } else
                                    {
                                        $("#daonboarding_preview .edit,.save-changes").show();
                                    }
                                    // end, code added by pr on 25thjan18
                                }
