            ...
            <div class="portlet-body form">
                ...
                <div id="nkn_bulk_preview">
                      <div class="col-md-12 mt-3 mb-3 p-0">
                        ...
                        <div>
                            <label class="k-radio k-radio--bold k-radio--brand">
                                <input type="radio" name="nkn_req_for1" id="mail"  value="mail" checked=""> Mail user (with mailbox)
                                <span></span>
                            </label>&emsp;&emsp;
                            <label class="k-radio k-radio--bold k-radio--brand">
                                <input type="radio" name="nkn_req_for1" id="app"  value="app" > Application user (without mail box(Eoffice-auth))<!-- text changed by pr on 5thmay2020 -->
                                <span></span>
                            </label>&emsp;&emsp;
                            <label class="k-radio k-radio--bold k-radio--brand">
                                <input type="radio" name="nkn_req_for1" id="eoffice"  value="eoffice" > e-office-srilanka
                                <span></span>
                            </label>&emsp;&emsp;
                        </div>
                        <font style="color:red"><span id="nkn_req_for_err"></span></font>
                    ...
                    <div class="col-md-12 mt-3 mb-3 p-0">
                        ...
                        <div>
                            <label class="k-radio k-radio--bold k-radio--brand">
                                <input type="radio" name="nkn_id_type1" id="nkn_bulk_id_type_1"  value="id_name" checked=""> Name Based
                                <span></span>
                            </label>&emsp;&emsp;
                            <label class="k-radio k-radio--bold k-radio--brand">
                                <input type="radio" name="nkn_id_type1" id="nkn_bulk_id_type_2"  value="id_desig" > Designation/Office based id
                                <span></span>
                            </label>&emsp;&emsp;
                        </div>
                        <font style="color:red"><span id="nkn_id_type_err"></span></font>
