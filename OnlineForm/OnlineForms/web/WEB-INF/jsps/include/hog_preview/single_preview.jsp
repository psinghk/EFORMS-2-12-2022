                ...
                <div id="div_for_self" class="display-hide">
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="emp_type" class="row">
                            ...
                            <div class="col-md-3">
                                <label class="k-radio k-radio--bold k-radio--brand">
                                    <input type="radio" name="single_emp_type" id="single_emp_type2"  value="consultant" >Consultant
                                    <span></span>
                                </label>
                            </div>
                            <div class="col-md-5">
                        ...
                        <div class="row form-group" >
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="emp_type">
                                    ...
                                    <label class="k-radio k-radio--bold k-radio--brand">
                                        <input type="radio" name="applicant_single_emp_type" id="applicant_single_emp_type2"  value="consultant" > Consultant
                                        <span></span>
                                    </label>&emsp;&emsp;
                                    <label class="k-radio k-radio--bold k-radio--brand">
