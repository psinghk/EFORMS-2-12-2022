...
<div class="row pt-3" style="margin: 0;background: #fff;box-shadow: 0px -2px 7px 4px #eee;">
    ...
    <span class="footer-msg-btn open-button btn-warning" onclick="openForm()"><i class="fa fa-plus"></i></span>
    <div class="footer-msg">
        <div class="chat-popup" id="myForm">
            <div class="form-container">
                ...
                <p>For any query, you may contact your Coordinator/DA:<br> <%=session.getAttribute("employment_data")%> </p>
                <% } %>
            </div>
        </div>
    </div>
