...
<div id="EditPreview"> 
    ...
    <div class="row form-group">
        <div class="col-md-6">
            ...
            <select class="form-control" id="user_employment" name="user_employment" readonly style="pointer-events: none">
        ...
        <div class="col-md-6" id="central_div" style="display:none">
            ...
            <select class='form-control' name='min' id='min' readonly style="pointer-events: none">
                <option value=''>-SELECT-</option>
            </select>
    ...
    <div class="row">
        <div class="col-md-12" id="central_div" style="display:none">
            <div class="form-group">
                ...
                <select class='form-control' name='dept' id='dept' readonly style="pointer-events: none">
                    <option value=''>-SELECT-</option>
                </select>
        ...
        <div class="col-md-12" id="state_div" style="display:none">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <select class='form-control' id="stateCode" name="stateCode" readonly style="pointer-events: none">
                        <option value=''>-SELECT-</option>
                    </select>
                ...
                <div class="col-md-6">
                    ...
                    <select class='form-control' name='state_dept' id='Smi' readonly style="pointer-events: none">
                        <option value=''>-SELECT-</option>
                    </select>
    ...
    <div class="row">
        <div  id="other_div" class="col-md-12" style="display:none">
            ...
            <select class='form-control' name='org' id='Org' readonly style="pointer-events: none">
                <option value=''>-SELECT-</option>
            </select>
    ...
    <div class="row">
        <div id="other_text_div"  class="display-hide col-md-12">
            ...
            <input type="text" id="other_dept" name="other_dept" readonly placeholder="Enter Department Name [Only characters,digits,whitespace,dot(.),comma(,),hypen(-),underscore(_),ampersand(&) allowed]" maxlength="100" class="form-control" /> 
