<div class="modal-dialog modal-lg single-page">
    <div class="modal-content" style="">
        ...
        <div class="modal-body"  id="centralutm_preview_tab">
            <!--Modal body start-->
            <div class="alert alert-primary"><span style="font-size: 16px;">Central UTM Services Form</span></div>
            <div class="portlet-body form">
                <div id="profile_div">
                    <jsp:include page="profile_preview.jsp" />
                </div>
                <div class="k-portlet__head">
                    <h3 class="theme-heading-h3-popup">Central UTM Services Entry Details</h3>
                </div>
                <div class="row" id="first_div">
                    <div class="col-md-2" style="padding-right:0px;">
                        <label for="street" id="dns_url_label">Source IP </label><span style="color: red;">*</span>
                        <input class="form-control class_name_url1" placeholder="Enter Source IP e.g : 164.100.X.X or IPV6 Address" type="text" name="firewall_sourceip[]" id="firewall_sourceip_1"  value="" maxlength="100" >
                    ...
                    <div class="col-md-2" style="padding-right:0px;">
                        ...
                        <input class="form-control class_name_dns class_name_url" placeholder="Enter Destination IP e.g : 164.100.X.X or IPV6 Address" type="text" name="firewall_destinationip[]" id="firewall_destinationip_1"  value="" maxlength="100"  >
                    ...
                    <div class="col-md-2" id="req_old_ip" style="padding-right:0px;">
                        ...
                        <select class='form-control' id="firewall_service_1" name="firewall_service[]">
                    ...
                    <div class="col-md-2" id="req_new_ip" style="padding-right:0px;">
                        ...
                        <input class="form-control class_name_loc" placeholder="EnterPorts e.g : 443" type="text" name="firewall_port[]" id="firewall_port_1"  value="" maxlength="100" >
                    ...
                    <div class="col-md-2" id="req_new_ip" style="padding-right:0px;">
                        ...
                        <select class='form-control' id="firewall_action_1" name="firewall_action[]">
                            <option value=''>-SELECT-</option>
                    ...
                    <div class="col-md-2" id="req_new_ip" style="padding-right:0px;">
                        ...
                        <input class="form-control class_name_loc" placeholder="Enter Time Period e.g : " type="text" name="firewall_time[]" id="firewall_timePeriod_1"  value="" maxlength="100" style="width:85%;display:inline;">
