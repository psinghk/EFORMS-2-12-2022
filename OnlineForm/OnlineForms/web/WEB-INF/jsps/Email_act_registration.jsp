...
<div class="k-content	k-grid__item k-grid__item--fluid k-grid k-grid--hor" id="k_content">
    ...
    <div class="k-content__head	k-grid__item">
        <div class="k-content__head-main">
            <h3 class="k-content__head-title">Brand Aside</h3>
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                <div class="tab-pane active" id="tab2" >
                                    <form action="" method="post" id="email_act_deact1" class="form_val">
                                        <div class="col-md-12" style="margin-top: 25px;">
                                            <h4 class="theme-heading-h3">Email id activate/deactivate</h4>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <label class="control-label" for="street">Email id activate/deactivate: <span style="color: red">*</span></label>
                                            <div id="dns_service">
                                                <label class="k-radio k-radio--bold k-radio--brand">
                                                    <input type="radio" name="email_act_deact" id="activate"  value="activate" checked=""> activate
                                                    <span></span>
                                                </label>&emsp;&emsp;
                                                <label class="k-radio k-radio--bold k-radio--brand">
                                                    <input type="radio" name="email_act_deact" id="deactivate"   value="deactivate" > deactivate
                                        ...
                                        <div class="col-md-12">
                                            <p><input type="checkbox" value='<%=email%>' name="checkbox_class"><%=email%></p>
                                        </div>
                                        <%  }%>
...
<div class="modal fade bs-modal-lg" id="large" tabindex="-1" role="dialog" aria-hidden="true">
    <form role="form" id="email_act_deact2" method="post">
...
<div class="modal fade" id="stack3" tabindex="-1">
    <form id="email_active_form_confirm">
        <%
            if (!nic_employee) {%>
...
<script src="main_js/email_act_deact.js" type="text/javascript"></script>
