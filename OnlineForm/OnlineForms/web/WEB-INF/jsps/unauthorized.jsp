    ...
    <div class="wrapper display-show" id="retired_basic">
        <div class="col-md-6 m-auto">
            <div id="wizard">
                ...
                <h5 class="text-center mt-5 mb-4 text-danger">It seems your IP has been changed!!! Kindly refresh the page and try again!!!</h5>
                <div style="overflow:auto;" class="mt-2">
                    <div class="col-md-12 p-0" style="text-align: center;">
                        <button type="button" class="btn btn-primary btn-action" id="submit"><a href="https://eforms.nic.in/showUserData" style="color: #ffff;">Go Back</a></button>
                    </div>
                </div>
            </div>
        </div>
