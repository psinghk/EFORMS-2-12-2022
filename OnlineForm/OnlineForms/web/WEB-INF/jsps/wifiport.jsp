...
<%
    ...
    boolean nic_employee = userdata.isIsNICEmployee();
     boolean isHod = userdata.isIsHOD();
     boolean isHog = userdata.isIsHOG();
                        ...
                        <div class="form-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab2" >
                                    ...
                                    <form action="" method="post" id="wifiport_form1" class="form_val">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td contenteditable="false" placeholder="[Permit/Deny]" class="attrName borderheading pHolder"><select class='form-control act' id="" name="">
                                                      ...
                                                      <td contenteditable="false"  class="attrName borderheading pHolder"><select class='form-control tym' id="" name="">
                                                            <option value=''>-SELECT-</option>
...
<div class="modal fade bs-modal-lg" id="large" tabindex="-1" role="dialog" aria-hidden="true">
    <form role="form" id="wifiport_form2" method="post">
        <jsp:include page="include/wifiport_preview.jsp" />
    </form>
    <!-- /.modal-dialog -->
</div>
<!-- /.modal -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">                           
                ...
                <br/>
                <ol>
                    <li>Users are requested to install the personal wifiport software to secure their machine and e-mail traffic.</li>
...
<div class="modal fade" id="stack3" tabindex="-1">
    <form id="wifiport_form_confirm">
        <%if (isHod || isHog) {%>
        <jsp:include page="include/Cod_details_wifiport.jsp" />
        <% } else {%>
