...
<body>
    ...
    <div class="wrapper" id="retired_basic">
        <div class="col-md-6 m-auto">
            <div id="wizard">
                ...
                <h5 class="text-center mt-5 mb-4 text-danger">Your account is not expiring this month!! Kindly revisit this portal in the month in which your account will be expiring.</h5>
