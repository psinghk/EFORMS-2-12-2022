...
<body>
    ...
    <div class="wrapper display-show" id="retired_basic">
        <div class="col-md-6 m-auto">
            <div id="wizard">
                <div class="retired-officers_session" style="padding-top: 70px;">
                    <div class="oops_retired">
                        OOPS
                    </div>
                    <h5 class="text-center text-danger">Somthing went wrong!, Please Try again after sometime. </h5>
