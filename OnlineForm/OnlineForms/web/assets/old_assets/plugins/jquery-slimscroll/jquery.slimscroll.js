 ...
 *
 * Improved by eformsthemes for Metronic Theme
 * Version: 1.3.2
 *
 */
(function($) {
    ...
    jQuery.fn.extend({
        slimScroll: function(options) {
            ...
            var defaults = {
                ...
                // sets animation status on a given scroll(added my eformsthemes)
                animate: true
            };
            ...
            this.each(function() {
                ...
                //begin: windows phone fix added by eformsthemes
                if ('ontouchstart' in window && window.navigator.msPointerEnabled) {
                  me.css("-ms-touch-action", "none");
              }
                //end: windows phone fix added by eformsthemes
